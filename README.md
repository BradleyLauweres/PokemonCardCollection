...
A sleek Pokémon Trading Card Game collection tracker powered exclusively by the TCGdex API that runs **100% serverless via GitHub Pages**, saving all your card collection data directly to [`collection.json`](./collection.json) in your GitHub repository via the GitHub REST API.
...
* **Powered by TCGdex API**: Fast, reliable card and set data with high-res WebP card art and Cardmarket market prices.
